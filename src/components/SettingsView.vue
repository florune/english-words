...
<template>
  <main class="page settings-page">
    ...
    <section class="settings-group attribution"><h2>词库与许可</h2><p>词库来自 Allison Parrish 的 <a href="https://github.com/aparrish/wordfreq-en-25000" target="_blank" rel="noreferrer">wordfreq-en-25000</a>，原数据来自 Robyn Speer 的 wordfreq。</p><p>美式 IPA 由 <a href="https://github.com/cmusphinx/cmudict" target="_blank" rel="noreferrer">CMU Pronouncing Dictionary</a> 转换而来，包含变体读音。</p><p>数据按 <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank" rel="noreferrer">CC BY-SA 4.0</a> 提供；本项目保留了原始词序和频率值。</p></section>
  </main>
</template>
